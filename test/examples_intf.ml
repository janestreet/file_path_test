...
module Definitions = struct
  (** Inputs to functions like [Path.make_relative]. See also [Helpers.With_if_under],
      which tells the test framework how to pass [t] as multiple arguments. *)
  ...
  (** Inputs to functions like [Path.is_prefix]. See also [Helpers.With_prefix], which
      tells the test framework how to pass [t] as multiple arguments. *)
  ...
  module type Path = sig
    ...
    val for_make_absolute : t With_under.t list
    val for_make_relative : t With_if_under.t list
...
module type Examples = sig
  ...
  module Path : Path with type t := File_path.t
end
